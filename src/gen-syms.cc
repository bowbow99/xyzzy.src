...
static symbols lsp[] =
{
  ...
  MAKE_SYMBOL2Q (type),
  MAKE_SYMBOL2Q (declaration),
  MAKE_SYMBOL2Q (ignore),
  MAKE_SYMBOL2Q (dynamic-extent),
  MAKE_SYMBOL2Q (inline),
  MAKE_SYMBOL2Q (ftype),
  MAKE_SYMBOL2Q (notinline),
  MAKE_SYMBOL2Q (ignorable),
  MAKE_SYMBOL2Q (optimize),
